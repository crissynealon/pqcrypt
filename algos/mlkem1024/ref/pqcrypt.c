...
/**
 * @brief MLKEM1024 encryption function
 *
...
int PQCRYPT_mlkem1024_encrypt(uint8_t *ct, const uint8_t *pt, const uint8_t *pk) {
    ...
    PQCLEAN_MLKEM1024_CLEAN_indcpa_enc(ct, pt, pk, coins);

    return 0;  // Success
}

/**
 * @brief MLKEM1024 decryption function
 *
...
int PQCRYPT_mlkem1024_decrypt(uint8_t *pt, const uint8_t *ct, const uint8_t *sk) {
    ...
    PQCLEAN_MLKEM1024_CLEAN_indcpa_dec(pt, ct, sk);
