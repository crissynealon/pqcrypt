...
#define cffi_crypto_encrypt PQCRYPT_ntruhps2048677_encrypt
#define cffi_crypto_decrypt PQCRYPT_ntruhps2048677_decrypt
...
int PQCRYPT_ntruhps2048677_encrypt(uint8_t *ct, const uint8_t *pt, const uint8_t *pk);
int PQCRYPT_ntruhps2048677_decrypt(uint8_t *pt, const uint8_t *ct, const uint8_t *sk);
