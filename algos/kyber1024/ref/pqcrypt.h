...
#define cffi_crypto_encrypt PQCRYPT_kyber1024_encrypt
#define cffi_crypto_decrypt PQCRYPT_kyber1024_decrypt
...
int PQCRYPT_kyber1024_encrypt(uint8_t *ct, const uint8_t *pt, const uint8_t *pk);
int PQCRYPT_kyber1024_decrypt(uint8_t *pt, const uint8_t *ct, const uint8_t *sk);
