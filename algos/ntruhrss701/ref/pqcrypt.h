...
#define cffi_crypto_encrypt PQCRYPT_ntruhrss701_encrypt
#define cffi_crypto_decrypt PQCRYPT_ntruhrss701_decrypt
...
int PQCRYPT_ntruhrss701_encrypt(uint8_t *ct, const uint8_t *pt, const uint8_t *pk);
int PQCRYPT_ntruhrss701_decrypt(uint8_t *pt, const uint8_t *ct, const uint8_t *sk);
