...
/**
 * @brief ntruhps2048509 encryption function
 *
 ...
 */
int PQCRYPT_ntruhps2048509_encrypt(uint8_t *ct, const uint8_t *pt,
                                   const uint8_t *pk) {
    poly r, m;
 ...
 * @return int       Returns 0 for success, non-zero for failure
 */
int PQCRYPT_ntruhps2048509_decrypt(uint8_t *pt, const uint8_t *ct,
                                   const uint8_t *sk) {
