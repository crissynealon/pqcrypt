...
#define cffi_crypto_encrypt PQCRYPT_kyber768_90s_encrypt
#define cffi_crypto_decrypt PQCRYPT_kyber768_90s_decrypt
...
int PQCRYPT_kyber768_90s_encrypt(uint8_t *ct, const uint8_t *pt, const uint8_t *pk);
int PQCRYPT_kyber768_90s_decrypt(uint8_t *pt, const uint8_t *ct, const uint8_t *sk);
