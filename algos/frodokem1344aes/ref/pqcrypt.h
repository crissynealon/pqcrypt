...
#define cffi_crypto_encrypt PQCRYPT_frodokem640aes_encrypt
#define cffi_crypto_decrypt PQCRYPT_frodokem640aes_decrypt
...
#define CFFI_CRYPTO_PLAINTEXTBYTES  BYTES_MU
