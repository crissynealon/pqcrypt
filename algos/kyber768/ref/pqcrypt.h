...
#define cffi_crypto_encrypt PQCRYPT_kyber768_encrypt
#define cffi_crypto_decrypt PQCRYPT_kyber768_decrypt
...
int PQCRYPT_kyber768_encrypt(uint8_t *ct, const uint8_t *pt, const uint8_t *pk);
int PQCRYPT_kyber768_decrypt(uint8_t *pt, const uint8_t *ct, const uint8_t *sk);
