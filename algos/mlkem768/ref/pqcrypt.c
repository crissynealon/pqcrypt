...
/**
 * @brief MLKEM768 encryption function
 *
...
int PQCRYPT_mlkem768_encrypt(uint8_t *ct, const uint8_t *pt, const uint8_t *pk) {
    ...
    PQCLEAN_MLKEM768_CLEAN_indcpa_enc(ct, pt, pk, coins);

    return 0;  // Success
}

/**
 * @brief MLKEM768 decryption function
 *
...
int PQCRYPT_mlkem768_decrypt(uint8_t *pt, const uint8_t *ct, const uint8_t *sk) {
    ...
    PQCLEAN_MLKEM768_CLEAN_indcpa_dec(pt, ct, sk);
