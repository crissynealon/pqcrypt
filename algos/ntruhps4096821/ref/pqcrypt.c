...
/**
 * @brief ntruhps4096821 encryption function
 *
 ...
 */
int PQCRYPT_ntruhps4096821_encrypt(uint8_t *ct, const uint8_t *pt,
                                   const uint8_t *pk) {
    poly r, m;
 ...
 * @return int       Returns 0 for success, non-zero for failure
 */
int PQCRYPT_ntruhps4096821_decrypt(uint8_t *pt, const uint8_t *ct,
                                   const uint8_t *sk) {
