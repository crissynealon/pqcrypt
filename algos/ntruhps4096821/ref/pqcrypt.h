...
#define cffi_crypto_encrypt PQCRYPT_ntruhps4096821_encrypt
#define cffi_crypto_decrypt PQCRYPT_ntruhps4096821_decrypt
...
int PQCRYPT_ntruhps4096821_encrypt(uint8_t *ct, const uint8_t *pt, const uint8_t *pk);
int PQCRYPT_ntruhps4096821_decrypt(uint8_t *pt, const uint8_t *ct, const uint8_t *sk);
